...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentManager.beginTransaction().add(R.id.container_top_row, stationsFragmentTop).commit();
        fragmentManager.beginTransaction().add(R.id.container_middle_row, stationsFragmentMiddle).commit();
        fragmentManager.beginTransaction().add(R.id.container_bottom_row, stationsFragmentBottom).commit();
