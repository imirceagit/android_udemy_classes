...
import com.mient.radiomi.radiomi.adapters.PlaylistsAdaptor;
...
public class PlaylistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.recycler_playlist);
        recyclerView.setHasFixedSize(true);

        PlaylistsAdaptor adaptor = new PlaylistsAdaptor(DataService.getInstance().getFeaturePlaylist());
